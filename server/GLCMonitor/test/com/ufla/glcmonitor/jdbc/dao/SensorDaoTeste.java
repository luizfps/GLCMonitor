...
public class SensorDaoTeste {
	...
	public void inicializa() throws SQLException {
		...
		sensor2 = UtilTestes.getSensor(1L, "GE42", UtilTestes.getLimitesDeTemperatura(-10F, 25F),
				0.5F, usuario2, null);
		sensor3 = UtilTestes.getSensor(2L, "HS76", UtilTestes.getLimitesDeTemperatura(-70F, 120F),
				0.003F, usuario1, null);
	...
	public void adicionaSensorAtrNullTeste() throws SQLException {
		...
		sensorDao.adiciona(UtilTestes.getSensor(0L, null, null, null, null, null),
				"teste1@email.com");
		List<Sensor> sensores = sensorDao.getLista();
